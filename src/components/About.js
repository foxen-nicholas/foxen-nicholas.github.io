      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg;flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
            Hello, I'm Nicholas.
            <br className="hidden lg:inline-block" /> I love to build creative apps.
          </h1>
          ...
          <div className="flex justify-center">
            <a className="m-12 inline-flex bg-white" href="https://www.linkedin.com/in/nicholas-foxen-57338b172/">
              <img src="./LinkedInIcon.png" alt="linkedIn icon" />
            </a>
            <a className="m-12 inline-flex bg-white" href="https://github.com/foxen-nicholas">
              <img src="./githubIcon.png" alt="github icon" />
            </a>
          </div>
        </div>
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <img className="object-cover object-center rounded" alt="hero" src="./profilepic.png" />
        </div>
      </div>
    </section>   
  );
